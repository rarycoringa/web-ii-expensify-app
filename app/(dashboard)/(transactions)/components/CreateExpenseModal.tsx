...
import { apiCreateExpense, apiFetchAccounts } from "@/app/lib/api";

interface CreateExpenseModalProps {
    onExpenseCreated?: () => void;
}

export default function CreateExpenseModal({ onExpenseCreated }: CreateExpenseModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await apiCreateExpense(description, parseFloat(amount), date, accountId);
            setDescription("");
            setAmount("");
            setDate("");
            setAccountId("");
    ...
    return (
        <Dialog.Root open={open} onOpenChange={(e) => setOpen(e.open)} placement="center">
            ...
            <Dialog.Positioner>
                <Dialog.Content>
                    <Dialog.Header>
                        <Dialog.Title>Create New Expense</Dialog.Title>
                    </Dialog.Header>
                    <Dialog.CloseTrigger />
